...
- Next.js pages provide basic forms for environments, services, routes, and change requests. A new publishing screen surfaces validation issues, config hashes, and history. There is still no authentication, role awareness, diffing, or approval gating in the UI, though an observability page now exposes live counts and recent publishes from the API.【F:frontend/pages/environments.tsx†L1-L71】【F:frontend/pages/services.tsx†L1-L74】【F:frontend/pages/routes.tsx†L1-L134】【F:frontend/pages/change-requests.tsx†L1-L108】【F:frontend/pages/publish.tsx†L1-L97】【F:frontend/pages/observability.tsx†L1-L78】
...
- **Epic G (Observability):** An overview endpoint summarizes counts and last publishes; the UI now surfaces this data but still lacks dashboarding or a metrics pipeline.【F:backend/Services/ObservabilityService.cs†L8-L21】【F:backend/Program.cs†L158-L159】【F:frontend/pages/index.tsx†L5-L25】【F:frontend/pages/observability.tsx†L1-L78】
